...
with open("C:/Users/5637171/Bachelor_Thesis/Data/saltConcentration/12-05-2020_highC/0.txt") as f:
    lines = f.readlines()
...
with open("C:/Users/5637171/Bachelor_Thesis/Data/saltConcentration/12-05-2020_highC/0.03.txt") as f:
    lines = f.readlines()
    an_003 = [float(line.split()[1]) for line in lines]
    cat_003 = [float(line.split()[2]) for line in lines]

with open("C:/Users/5637171/Bachelor_Thesis/Data/saltConcentration/12-05-2020_highC/0.06.txt") as f:
    lines = f.readlines()
    an_006 = [float(line.split()[1]) for line in lines]
    cat_006 = [float(line.split()[2]) for line in lines]
    
with open("C:/Users/5637171/Bachelor_Thesis/Data/saltConcentration/12-05-2020_highC/0.09.txt") as f:
    lines = f.readlines()
    an_009 = [float(line.split()[1]) for line in lines]
    cat_009 = [float(line.split()[2]) for line in lines]
    
with open("C:/Users/5637171/Bachelor_Thesis/Data/saltConcentration/12-05-2020_highC/0.12.txt") as f:
    lines = f.readlines()
    an_012 = [float(line.split()[1]) for line in lines]
    cat_012 = [float(line.split()[2]) for line in lines]
    
with open("C:/Users/5637171/Bachelor_Thesis/Data/saltConcentration/12-05-2020_highC/0.15.txt") as f:
    lines = f.readlines()

...
Diff = 10**-9
Phi = 0.025
Omega = [100, 500, 400*math.pi, 5000, 10000, 50000, 104719.7551, 250000, 500000, 1324169.717]

E_theory = [(i*Phi*(Length*Kappa + 2*math.sqrt(Length*Kappa)))/(math.sqrt(2)*Length*Kappa*(i*Length + 2*Diff*Kappa)) for i in Omega]
E_Numerical = [8.391182825666391, 41.80725981993905, 105.0471501568999, 417.989290692442, 836.5720023805205, 4174.598168651755, 8232.105499029609, 19847.88892743242, 34838.29436083642, 54772.480486267865]
print(E_theory)
